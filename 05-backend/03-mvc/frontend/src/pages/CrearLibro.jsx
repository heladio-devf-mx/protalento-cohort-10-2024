...
const CrearLibro = () => {
  ...
  const yupSchema = yup.object({
    titulo: yup.string().required("Escribe un tiulo"),
    autor: yup.string().required("Selecciona un autor"),
    pais: yup.string(),
    genero: yup.string().required("Elige un genero").oneOf(["Novela", "Cuento", "Ciencia Ficción"])
  }).required();
